...
In **Phase 1** of the competition, teams were challenged to design **adversarial prompts** capable of forcing a Large Language Model (LLM) to violate its safety policies — a technique known as:
...
## 🌐 Evaluation Domains (14 Categories)
